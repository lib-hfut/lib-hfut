...
[![DOWNLOAD](https://img.shields.io/badge/Size-1.65GB-%23FF4D5B.svg?style=flat-square)](https://github.com/lib-hfut/lib-hfut/archive/master.zip)
[![CONTACTUS](
...
- 如果你想批量下载文件, 也可以进入 `FTP镜像站` 下载。镜像站每日自动同步。复制地址 `ftp://lib-hfut.tk/lib-hfut` 到 `我的电脑/此电脑` 的地址栏, 回车即可进入镜像站, 然后复制想要的文件/文件夹到本地。`注意`: 如果访问出现问题, 请查阅 [无法访问/无法连接/无法下载的通用解决方法](https://jingyan.baidu.com/article/b7001fe1829deb0e7282ddb7.html) 或利用搜索引擎自行解决
